...
Nine Miles from the White City, 2013, -`;
    ...
    peopleData = [
        ...
        { disabled: true, name: 'Bradley Greer', role: 'Software Engineer', salary: '$132,000', office: 'London', extn: 2558, email: 'b.greer@datatables.net' },
        { name: 'Brenden Wagner', role: 'Software Engineer', salary: '$206,850', office: 'San Francisco', extn: 1314, email: 'b.wagner@datatables.net' },
        { bold: true, name: 'Brielle Williamson', role: 'Integration Specialist', salary: '$372,000', office: 'New York', extn: 4804, email: 'b.williamson@datatables.net' },
