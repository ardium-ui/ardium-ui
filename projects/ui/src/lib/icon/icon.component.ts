...
export class ArdiumIconComponent implements AfterViewInit {
    ...
    @Input()
    get filled(): boolean | undefined { return this._filled; }
    set filled(v: any) {
    ...
    @Input()
    get weight(): WeightNumber | undefined { return this._weight; }
    ...
    @Input()
    get grade(): GradeNumber | undefined { return this._grade; }
    ...
    @Input()
    get opticalSize(): OpticalSizeNumber | undefined { return this._opticalSize; }
    ...
    get fontVariationSettings(): string {
        if (!this._isMemoUpToDate) {
            ...
            this._fontVariationMemo = propObjectAsArray.length === 0 ? "" : [
