...
export class ArdiumProgressCircleComponent {
    ...
    set value(v: any) { this._value = coerceNumberProperty(v, 0); }

    private _max: number = 100;
    @Input()
    get max(): number { return this._max; }
    set max(v: any) { this._max = coerceNumberProperty(v, 100); }

    get percentValue(): number { return this.value / this.max * 100; }
    ...
    //! templates
    @ContentChild(ArdProgressCircleValueTemplateDirective, { read: TemplateRef }) valueTemplate?: TemplateRef<any>;
