...
import { _FocusableComponentBase, _FocusableComponentBaseWithDefaults } from '../_internal/focusable-component';
...
@Directive()
export abstract class _ButtonBaseWithDefaults extends _FocusableComponentBaseWithDefaults {
