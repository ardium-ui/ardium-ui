...
import { _FocusableComponentBase, _FocusableComponentBaseWithDefaults, _focusableComponentDefaults, _FocusableComponentDefaults } from './focusable-component';
 ...
 */
@Directive()
export abstract class _NgModelComponentBaseWithDefaults extends _FocusableComponentBaseWithDefaults implements ControlValueAccessor {
